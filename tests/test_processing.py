...
def test_filter_by_state(operations: List[Dict[str, Any]], state: str, expected_ids: List[int]) -> None:
...
def test_sort_by_date_reverse(operations: List[Dict[str, Any]]) -> None:
